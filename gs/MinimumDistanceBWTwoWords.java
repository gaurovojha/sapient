...
public class MinimumDistanceBWTwoWords {
	public static void main(String[] args) {	    
	   // String s="heyy how   are you ? how you   are doing?";
		...
		String s = "ABC IS A XYZ and ABC & XYZ are two distinct words";
	    ...
	    System.out.println(getMinDIstance(s,"ABC", "XYZ"));
	  ...
	  //  System.out.println("words length:"+words.length);
	    ...
	    for(String word:words){ 
	      ...
	      System.out.println(
					"d1 : " + d1 + "**" + "d2 :" + d2 + " dis" + Math.abs(d2 - d1) + "min distance" + minDistance);
	      if(dist<minDistance)
	          minDistance=dist;      
